...
this.table <-           ggrisktable(fit = kidneyRNASurvENSG00000065328, data = KidneySurv, 
                                    risk.table.type = "absolute",
                                    y.text = FALSE,
                                    color = "strata",
                                    palette = c("skyblue1", "deeppink1"),
                                    fontcolor = "black",
                                    fontsize = 10,
                                    xlab = NULL)

this.table <-  ggpar(this.table,
                       font.title    = c(34, "plain", "black"),         
                       font.caption  = c(14, "plain"),        
                       font.x        = c(30, "italic"),          
                       font.y        = c(30, "italic"),      
                       ...
                       font.ytickslab = c(30, "plain"),
                       font.legend   = c(30, "plain", "black"),
                       font.tickslab = c(30, "plain", "green")
)


###########################################################################
### making composite KM figure
# jpeg(filename = "../figs/Kidney_KM_curve_composite.jpg", width = 8000, height = 8000, res = 300)
# ggarrange(ggsurvkm_ENSG00000065328$plot, 
#           NULL, 
#           ggsurvkm_CATG00000107122$plot,
#           
#           ggrisktable(fit = kidneyRNASurvENSG00000065328, data = KidneySurv, 
#                       risk.table.type = "absolute",
#                       y.text = FALSE,
#                       color = "black",
#                       palette = c("skyblue1", "deeppink1"),
...
#           #NULL, NULL, NULL,
#           
#           ggsurvkm_ENSG00000235989$plot, 
#           NULL,
#           ggsurvkm_ENSG00000196756$plot,
#           
#           ggrisktable(fit = kidneyRNASurvENSG00000065328, data = KidneySurv, risk.table.type = "absolute"),
#           NULL,
#           ggrisktable(fit = kidneyRNASurvENSG00000065328, data = KidneySurv, risk.table.type = "absolute"),
#           
#           labels = c("a", "", "b", "", "", "", "c", "", "d", "", "", ""),
