...
saveDFtoFiles <- function(x, y) {
  ...
  write.csv(temp.df, file = paste("../text/intergenicPlncRNA/SigIntergenicPlncRNA_", x, ".csv", sep = ""))
}
...
write.csv(summaryDF, file = "../text/intergenicPlncRNA/significantIntergenicPromByTCGAtypes.csv")
...
write.csv(x = ipromNamesPredictives, file = "../text/intergenicPlncRNA/union_of_predictive_iplncRNA_through_tumors_list.csv")
